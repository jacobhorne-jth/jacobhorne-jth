...
- ⚡ **[ContextCUDA](https://github.com/jacobhorne-jth/context-cuda)** — exploring custom C++/CUDA kernels for long-context LLM inference, including attention, RoPE, KV-cache management, and context efficiency

## Experience

- **Sandia National Laboratories** — **Software Engineer Intern**  
...
- **[PROP.INTEL](https://github.com/jacobhorne-jth/prop-intel)** · *IrvineHacks 2026*  
...
- **[Agonus](https://github.com/blockchainuci/Agonus)** · *Blockchain @ UCI*  
...
- **[EthicsChat](https://github.com/TCS-COMPSCI-180A/chatbot)** · *Tata Consultancy Services*  
...
- **[GitHub Onboarding Agent](https://github.com/jacobhorne-jth/github-onboarding-agent)** · *Personal Project*  
...
- **[The First Tokens Matter: Early Confidence Signals for Evaluating LLM Reasoning](https://openreview.net/forum?id=0FOOrwSQ9E)** — ICLR 2026 LLM Reasoning Workshop
- **[The Confident Liar: Diagnosing Multi-Agent Debate with Log-Probabilities and LLM-as-Judge](https://aclanthology.org/2026.acl-srw.121/)** — ACL 2026 Student Research Workshop
- **[Early-Token Confidence Predicts Reasoning Quality in Multi-Agent LLM Debate](https://aclanthology.org/2026.gem-main.60/)** — GEM 2026
